...
export declare const createProjectionState: () => {
    isEnabled: boolean;
    isTargetLocked: boolean;
    target: AxisBox2D;
    targetFinal: AxisBox2D;
};
export declare function createVisualState(props: MotionProps, parent?: VisualElement, blockInitialAnimation?: boolean): ResolvedValues;
/**
