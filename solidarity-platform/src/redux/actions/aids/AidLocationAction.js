import {
	FETCH_AID_LOCATION_REQUEST,
	FETCH_AID_LOCATION_SUCCESS,
	FETCH_AID_LOCATION_FAILURE,
} from "../../types/aids/AidLocationTypes";
...
export const fetchAidLocations = () => {
	return (dispatch) => {
		...
		axios
			.get("http://localhost:5000/map/api/helps/locations")
			.then((response) => {
